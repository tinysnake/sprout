...
<template>
  <div class="flex flex-col h-full bg-[var(--bg-app)]">
    ...
    <div class="p-6 max-w-4xl mx-auto flex-1 flex flex-col justify-center">
      <EmptyState
        icon="settings"
        title="Manage / Settings"
        description="Operator sessions, credential rotation, schema compatibility, and sanitized diagnostics are scheduled for downstream migration."
      />
    </div>
  </div>
</template>
