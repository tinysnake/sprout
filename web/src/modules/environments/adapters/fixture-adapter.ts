...
export function createInitialFixtures(): EnvironmentInstance[] {
  return [
    ...
    },
    {
      ...
      platform: 'container',
      trafficLight: 'yellow',
      trafficLightReason: 'Worker reconnected · Carrier online · Reconciling settlement evidence',
      enrollmentStatus: 'approved',
      connectionState: 'online',
      connectionAgeSec: 4,
      lastConfirmedTime: '4s ago',
      protocolVersion: 'v2.1',
      protocolCompatibility: 'compatible',
      workSafety: 'reconciling',
      activeLeaseHolder: {
        holderId: '108',
        holderKind: 'task',
        taskTitle: 'Distributed Agent Synchronization',
        projectId: 'sprout-m2',
        leadAgentName: 'Programmer',
        acquiredAt: '2026-09-19 10:05:00',
      },
      leaseRecovery: {
        cause: 'Worker carrier reconnected after transient network drop; reconciling local evidence',
        interruptedRunId: 'run-210',
        interruptedRunAgent: 'Programmer',
        unresolvedFacts: [
          'Engine process stop verification pending on host',
          'Locally retained execution turns awaiting synchronization',
        ],
      },
      capabilityPermissions: {
        fileReadWrite: true,
      ...
      engineDetails: {
        codex: { version: 'v0.9.4', authStatus: 'authenticated' },
        pi: { version: 'v1.4.0', authStatus: 'authenticated' },
        agy: { version: 'v0.6.2', authStatus: 'authenticated' },
        opencode: { version: 'v1.0.1', authStatus: 'authenticated' },
      },
      probeHistory: [
        {
          timestamp: '10:13:50',
          ...
          protocolOk: true,
          enginesOk: true,
          summary: 'Carrier re-established; protocol v2.1 validated',
        },
      ],
      boundWorkspaces: [
        {
          projectId: 'sprout-m2',
          projectDisplayName: 'Sprout M2 Operator',
          workspaceRoot: 'linux-worker-mount',
          relativeWorkspacePath: 'builds/sprout',
          status: 'Prepared & Ready',
        },
      ],
    },
