  ...
  principlesCard.innerHTML = `
    <div class="card-header">
      <h2 style="font-size: 16px; font-weight: 700; display: flex; align-items: center; gap: 8px;">
        <span>📊</span> Usage & Monetary-Cost Observability (ADR-0010)
      </h2>
  ...
  viewTabsCard.innerHTML = `
    <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 8px;">
      ...
      <div class="segmented-control" style="overflow-x: auto;">
        <button class="segmented-btn ${currentTab === 'run' ? 'active' : ''}" data-tab="run">1. By Run</button>
        <button class="segmented-btn ${currentTab === 'task' ? 'active' : ''}" data-tab="task">2. By Task</button>
        <button class="segmented-btn ${currentTab === 'project' ? 'active' : ''}" data-tab="project">3. By Project</button>
        <button class="segmented-btn ${currentTab === 'agent' ? 'active' : ''}" data-tab="agent">4. By Agent</button>
        <button class="segmented-btn ${currentTab === 'model' ? 'active' : ''}" data-tab="model">5. By Model</button>
        <button class="segmented-btn ${currentTab === 'time' ? 'active' : ''}" data-tab="time">6. By Time Range</button>
      </div>
  ...
  if (currentTab === 'run') {
    ...
    tabContent.innerHTML = `
      <div style="display: flex; flex-direction: column; gap: 6px;">
        ...
        <div style="background: var(--bg-surface-elevated); padding: 8px 12px; border-radius: var(--radius-sm); display: flex; justify-content: space-between; font-size: 12px;">
          <span>🔍 Reviewer (Codex / gpt-4o)</span>
          <strong>$0.0890 USD (98s wall)</strong>
        </div>
        <div style="background: var(--bg-surface-elevated); padding: 8px 12px; border-radius: var(--radius-sm); display: flex; justify-content: space-between; font-size: 12px;">
          <span>🎨 Designer (Codex / gpt-4o)</span>
