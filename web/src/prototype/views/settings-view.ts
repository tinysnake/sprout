...
export function renderSettingsView(state: PrototypeState): HTMLElement {
  ...
  container.innerHTML = `
    ...
    <section class="settings-status-strip" aria-label="Settings status summary">
      <div class="settings-status-item settings-status-normal"><span class="settings-status-icon">${renderIcon('check', 15)}</span><div><strong>Operator access</strong><span>Authenticated</span></div></div>
      <div class="settings-status-item settings-status-normal"><span class="settings-status-icon">${renderIcon('server', 15)}</span><div><strong>Instance</strong><span>Compatible</span></div></div>
      <div class="settings-status-item settings-status-warning"><span class="settings-status-icon">${renderIcon('warning', 15)}</span><div><strong>Migration guard</strong><span>Safety copy retained</span></div></div>
    </section>
